        ...
        <Col className='d-flex-inline justify-content-center'>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group>
              ...
              <Form.Control type='text' name='pname' placeholder='Enter the name of the project' value={FormData.pname} onChange={handleChange} />
            </Form.Group>
            <Form.Group>
              <Form.Label>Description</Form.Label>
              <Form.Control as='textarea' name='description' value={FormData.description} onChange={handleChange} />
            </Form.Group>
            <Input name='tags' label='Tags' value={FormData.tags} handleChange={handleTags} />
            <div className='d-flex mt-2 justify-content-end'>
              <Button variant='darktheme' type='submit'>Create</Button>
            </div>
          </Form>
        </Col>
      </Row>
