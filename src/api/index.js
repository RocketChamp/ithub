...
export const updateUser = (id, updatedUser) => API.post(`/user/${id}`, updatedUser);

export const deleteUser = (id) => API.post(`/user/${id}`);

export const followUser = (id, followingId) => API.post(`/user/${id}/${followingId}/follow`);

export const unfollowUser = (id, unfollowingId) => API.post(`/user/${id}/${unfollowingId}/unfollow`);
